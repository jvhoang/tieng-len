...
(function (root, factory) {
  ...
  function leafEval2p(state, myIdx) {
    ...
    // W10A residual structure: pairs + seq length remaining
    var byR = {}, i, r, pairR = 0, maxRun = 0, run = 0;
    for (i = 0; i < state.players[myIdx].hand.length; i++) {
      r = state.players[myIdx].hand[i].rank;
      byR[r] = (byR[r] || 0) + 1;
    }
    for (r = 0; r <= 11; r++) {
      var c = byR[r] || 0;
