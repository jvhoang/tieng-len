...
function defaultGenome() {
  ...
  return {
    ...
    shortHandB: 5, passHandMin: 4, passOppMin: 2, passMargin: 0.08, winProbEdge: 0.02, gen: 0, id: 'v1.0-sh-L2s47'
  };
}
...
const AI_BUILD = {
  id: "v1.0-sh-L2s47",
  stamped: "2026-07-15T14:56:45.420Z",
  label: "Freeze v1.0-sh-L2s47"
};
