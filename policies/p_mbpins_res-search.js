  ...
  function bestResponseMove(state, myIdx, opts) {
    ...
    for (var ai = 0; ai < actions.length; ai++) {
      ...
      if (act && act.length >= 2 && !cur) {
        ...
        // residual pair-left bias after FL multi
        try {
          var h0=root.players[myIdx].hand, used={}, byR={};
          ...
          var pairLeft=0;
          for (var rk in byR) if (byR[rk]-(used[rk]||0)>=2) pairLeft++;
          multiTie += 0.0015 * Math.min(3, pairLeft);
        } catch(e){}
      }
