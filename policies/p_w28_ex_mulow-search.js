...
(function (root, factory) {
  ...
  function expertPolicy(state, cp) {
    ...
    // W28 p_w28_ex_mulow: holdout convert 20270774 — min-top same-type multi when
      ...
      if (
        ...
        if (infoBR.twos >= 1 || infoBR.control >= 2) {
          ...
          if (brLow.length >= 2) {
            ...
            // Force min-top only — otherwise BR rates re-select high multi (convert null)
