...
(function (root, factory) {
  ...
  /**
   * p_minb ONE-AXIS: in combat (cur exists), among cheap/same-class answers prefer
   * minimal structure break, then minimal top rank (min-beat), then expertScore.
   * Free-lead (!cur) unchanged: pure expertScore.
   */
