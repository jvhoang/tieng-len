...
(function (root, factory) {
  ...
  function bestResponseMove(state, myIdx, opts) {
    ...
    if (!cur) {
      ...
      var shBR = (!sbc0BR && !meBR && !euBR) ? pickSeqHi(hand, cur, leg, state, myIdx) : null;
      var shrBR = (!sbc0BR && !meBR && !euBR && !shBR) ? pickSeqHiRes(hand, cur, leg, state, myIdx) : null;
      var saBR = (!sbc0BR && !meBR && !euBR && !shBR && !shrBR) ? pickSeqAdj(hand, cur, leg, state, myIdx) : null;
      var s5BR = (!sbc0BR && !meBR && !euBR && !shBR && !shrBR && !saBR) ? pickSeq5Adj(hand, cur, leg, state, myIdx) : null;
      var smuBR = (!sbc0BR && !meBR && !euBR && !shBR && !shrBR && !saBR && !s5BR) ? pickSeqMidUnder(hand, cur, leg, state, myIdx) : null;
      var phBR = (!sbc0BR && !meBR && !euBR && !shBR && !shrBR && !saBR && !s5BR && !smuBR) ? pickPairHi(hand, cur, leg, state, myIdx) : null;
      if (sbc0BR) {
        leg = [sbc0BR];
      } else if (meBR) {
        leg = [meBR];
