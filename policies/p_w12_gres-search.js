...
(function (root, factory) {
  ...
  function residualKeys(hand, play) {
    var used = Object.create(null), i, r, byR = Object.create(null), pairR = 0, maxRun = 0;
    ...
    for (r = 0; r <= 11; r++) if ((byR[r] || 0) >= 2) pairR++;
    // longest consecutive run using ranks with ≥1 card (non-2)
    var run = 0;
    for (r = 0; r <= 11; r++) {
  ...
  function orderLegals(legals, state, myIdx) {
    ...
    return legals.slice().sort(function (a, b) {
      // W12 gres: combat singles residual keys
