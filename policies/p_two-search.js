...
(function (root, factory) {
  ...
  function expertPolicy(state, cp) {
    ...
    // p_two probe: broaden 2-tempo reclaim (human H_2_E_non2) vs mid tops.
    // Expand v91 probe-TWO: omin<=4 (was 3), handLen<=10 (was 9), gate omin<=4 OR trash.
    // Prefer play 2 over mid single without bulk expertScore rewrite.
    if (
      cur.type === 'single' &&
      curTop >= 8 &&
      curTop <= 10 &&
