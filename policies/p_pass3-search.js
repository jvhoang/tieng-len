...
(function (root, factory) {
  ...
  function expertPolicy(state, cp) {
    ...
    // PASS3: contest more mid-tops (human H_play_E_pass mass) — gated, not bulk reverse
    if (handLen >= 11 && curTop < 8 && omin >= 8) return { pass: true }; // narrower soft-pass
    if (handLen >= 10 && curTop < 9 && omin >= 8) return { pass: true };
