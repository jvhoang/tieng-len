...
ok('center stage-area markup', /id="stage-area"/.test(html));
ok('stage / review CSS', /stage-fan|is-reviewing|stage-return-btn/.test(html));
ok('ui stages onto center before play', /stageCard|renderStage|selectedCards/.test(ui) && /STAGE A PLAY|staged — tap PLAY/.test(ui));
